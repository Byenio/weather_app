  ...
  return (
    <Card className="flex flex-wrap justify-items-center border-transparent">
      ...
      <CardHeader className="basis-full text-center">
        <CardTitle>Weather in {currentWeather.name}</CardTitle>
      ...
      <CardContent className="basis-full text-center">
        ...
        <div className="w-80 mx-auto">
          ...
          <p className="text-left"><b>Pressure:</b> {currentWeather.main.pressure} hPa</p>
          <p className="text-left"><b>Humidity:</b> {currentWeather.main.humidity}%</p>
          <p className="text-left">
            <b>Wind:</b> {currentWeather.wind.speed}km/h
        ...
        <Accordion type="single" collapsible className="max-w-xs m-auto">
          ...
          <AccordionItem value="item-1">
            <AccordionTrigger><b>Forecast for upcoming days</b></AccordionTrigger>
            <AccordionContent>
